    ...
    <script>
        $(document).ready(function () {
                    ...
                    <div class="content-item">
                        ...
                        <div class="content-body">
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <select name="modules[${moduleIdx}][contents][${contentCount}][type]" class="form-control" required>
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <input type="text" name="modules[${moduleIdx}][contents][${contentCount}][content_data]" class="form-control" required>
                            </div>
                        </div>
                    </div>
                `;
            ...
            $('#modules-container').on('click', '.remove-content', function () {
                $(this).closest('.content-item').slideUp(200, function() {
                    $(this).remove();
                });
            });
